...
const editarquery = async() =>{
    ...
    const editarAlumno = await axios.post(url,objedit)
    setEditar(editarAlumno.data.students[0])
}
...
let  arrayAlumno = localStorage.getItem("editarlocal")
